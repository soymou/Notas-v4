...
$ (Gamma tack.r a: A  space space   Gamma tack.r f: A arrow.r B)/(Gamma tack.r f(a): B). $ 
...
$ (Gamma tack.r a: A)/(Gamma, x: A tack.r a = x "type"). $ 
...
$ text(#1.3em, mat( delim: #none , column-gap: #2em, row-gap: #1em,
    (Gamma, x: A tack.r B(x) "type")/(Gamma tack.r A "type"),
    (Gamma tack.r A equiv B "type")/(Gamma tack.r A "type");
    (Gamma tack.r A equiv B "type")/(Gamma tack.r B "type"), 
    (Gamma tack.r a: A)/(Gamma tack.r A "type");
    (Gamma tack.r a equiv b)/(Gamma tack.r a: A),
    (Gamma tack.r a equiv b)/(Gamma tack.r b: A)
)) $ 
...
$ text(#1.3em, mat(delim: #none, column-gap: #1em, row-gap: #1em,
    (Gamma tack.r A "type")/(Gamma tack.r A equiv A "type") ,
    (Gamma tack.r A equiv B "type")/(Gamma tack.r B equiv A "type") , 
    (Gamma tack.r A equiv B "type" quad Gamma tack.r B equiv C "type")/(Gamma tack.r A equiv C "type") ;
    (Gamma tack.r a: A)/(Gamma tack.r a equiv a: A),
    (Gamma tack.r a equiv b: A)/(Gamma tack.r b equiv a: A) ,
    (Gamma tack.r a equiv b: A quad Gamma tack.r b equiv c: A)/(Gamma tack.r a equiv c: A).
  )) $ 
...
$ (Gamma tack.r A equiv A'     "type"         Gamma, x: A, Delta tack.r B(x)     "type")/(Gamma, x: A', Delta tack.r B(x)     "type"). $ 
...
$ (Gamma tack.r A equiv A' quad Gamma, x: A, Delta tack.r cal(J))/(Gamma, x: A', Delta tack.r cal(J)). $ 
...
$ text(#1.3em,mat(delim: #none, column-gap: #1em, row-gap: #1em,
    (Gamma tack.r a equiv a': A quad Gamma, x: A, Delta tack.r B "type")/(Gamma, Delta[a slash x] tack.r B[a slash x] equiv B[a' slash x] "type") ; 
      (Gamma tack.r a equiv a': A quad Gamma, x: A, Delta tack.r b: B)/(Gamma, Delta[a slash x] tack.r b[a slash x] equiv b[a' slash x]: B[a slash x])
  )) $ 
...
$ (Gamma tack.r A "type" quad Gamma, Delta tack.r cal(J))/(Gamma, x: A, Delta tack.r cal(J))W. $ 
...
$ (Gamma tack.r A "type" quad Gamma tack.r B     "type")/(Gamma, x: A tack.r B      "type") $ 
...
$ (Gamma tack.r A "type")/(Gamma, x: A tack.r x: A) delta. $ 
