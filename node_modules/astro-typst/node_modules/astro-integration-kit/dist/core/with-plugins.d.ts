...
import { NonEmptyArray, Prettify } from '../internal/types.js';
 ...
 */
declare const withPlugins: <TPlugins extends NonEmptyArray<AnyPlugin>, Extensions extends Record<any, unknown>>(options: WithPluginsParams<TPlugins> & Extensions) => WithPluginsReturn<Prettify<Omit<Extensions, keyof WithPluginsParams<any>>>>;
