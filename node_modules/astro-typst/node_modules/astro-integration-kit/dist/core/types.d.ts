...
type Plugin<TName extends string, THooks extends PluginHooksConstraint> = {
    ...
    setup: (params: {
        name: string;
    }) => PluginPerHookSetup<THooks>;
};
type AnyPlugin = Plugin<string, Record<string, any>>;
...
type SimplifyPlugin<TPlugin extends AnyPlugin = AnyPlugin> = {
    name: TPlugin["name"];
    hooks: TPlugin extends Plugin<any, infer THooks> ? THooks : Record<string, never>;
};
/**
...
export type { AddedParam, AnyPlugin, ExtendedHooks, Hooks, Plugin, PluginHooksConstraint };
