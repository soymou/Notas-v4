...
export declare type Severity = 'information' | 'warning' | 'error';
...
export declare type SymbolKind = 'class' | 'definition' | 'meta' | 'inductive' | 'instance' | 'structure' | 'theorem';
...
export declare type GoalState = string;
...
export declare type CheckingMode = 'nothing' | 'visible-lines' | 'visible-lines-and-above' | 'visible-files' | 'open-files';
...
export declare type WidgetEffect = {
    kind: 'insert_text';
    text: string;
} | {
...
export declare type WidgetEventRecord = WidgetEventRecordSuccess | WidgetEventRecordInvalid | WidgetEventRecordEdit | WidgetEventRecordError;
...
export declare type WidgetHtml = WidgetComponent | string | WidgetElement | null;
